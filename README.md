...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-g97vkes.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-g97vkes.containers.anotherwebservice.com/
...
```
git clone git@github.com:Olufowobikayode/container-g97vkes.git
cd container-g97vkes
```
...
```
docker attach container-g97vkes
```
